...
public class Icone {
    ...
    //  public final static Image bull = new ImageIcon(loader.getResource("taureau.png")).getImage();
    // public final static Image player = new ImageIcon(loader.getResource("player.png")).getImage().getScaledInstance(30 , 30, Image.SCALE_DEFAULT);
